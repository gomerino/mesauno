const steps = [
  { n: "1", title: "Crea tu invitación", body: "Nombre de los novios, fecha y estilo boarding pass en minutos." },
        ...
        <ol className="mx-auto mt-12 grid max-w-4xl gap-8 sm:grid-cols-3 sm:gap-6">
          {steps.map((s, i) => (
            <li key={s.n} className="relative text-center sm:text-left">
              ...
              <span className="mx-auto flex h-10 w-10 items-center justify-center rounded-full border border-[#D4AF37]/40 bg-[#D4AF37]/10 font-display text-sm font-bold text-[#D4AF37] sm:mx-0">
                {s.n}
              </span>
