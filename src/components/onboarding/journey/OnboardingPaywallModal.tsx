...
export function OnboardingPaywallModal({ open, onClose, eventId, prefillNombre, prefillEmail }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl border border-invite-gold/30 bg-gradient-to-b from-slate-900 to-[#020617] p-6 shadow-2xl sm:p-8">
        ...
        >
          <button
            ...
            className={[
              ...
              selected === "esencial"
                ? "border-2 border-invite-gold/55 bg-white/[0.06] shadow-[0_12px_40px_rgba(212,175,55,0.08)] ring-1 ring-invite-gold/25"
          ...
          >
            ...
            <p className="mt-1 text-lg font-bold text-invite-gold transition-opacity duration-300">{PRICING_PLANS.esencial.priceLabel}</p>
          ...
          <button
            ...
            className={[
              ...
              selected === "experiencia"
                ? "border-2 border-invite-gold bg-invite-gold/[0.09] shadow-[0_0_36px_rgba(212,175,55,0.22),0_12px_40px_rgba(212,175,55,0.12)] ring-1 ring-invite-gold/45"
                : "border border-invite-gold/25 bg-invite-gold/[0.04] hover:border-invite-gold/40",
            ].join(" ")}
          >
            <div
              className={
                "absolute -top-2.5 left-1/2 z-[1] -translate-x-1/2 whitespace-nowrap rounded-full px-3 py-0.5 text-[10px] font-bold uppercase tracking-wider " +
            ...
            <p className="pt-1 text-xs font-semibold uppercase tracking-wide text-invite-gold">Premium</p>
            <p className="mt-1 font-display text-lg font-bold text-white">{PRICING_PLANS.experiencia.name}</p>
            <p className="mt-1 text-lg font-bold text-invite-gold transition-opacity duration-300">{PRICING_PLANS.experiencia.priceLabel}</p>
        ...
        <div className="mt-5 space-y-3">
          <div>
            <label htmlFor="onb-paywall-nombre" className="block text-[11px] font-semibold uppercase tracking-wider text-invite-gold/85">
              Nombre
            </label>
            <input
          ...
          <div>
            <label htmlFor="onb-paywall-email" className="block text-[11px] font-semibold uppercase tracking-wider text-invite-gold/85">
              Email
            </label>
            <input
        ...
        <button
          type="button"
          disabled={busy}
          className={panelCtaJurnexPrimary + " mt-5 min-h-[48px] w-full justify-center px-4 text-center disabled:opacity-60"}
